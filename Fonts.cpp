...
int Fonts::Load(Application* app, const char* texture_path, const char* characters, uint rows)
{
	int id = -1;
...
void Fonts::UnLoad(Application* app, int font_id)
{
...
void Fonts::BlitText(Application* app, int x, int y, int font_id, const char* text) const
{
